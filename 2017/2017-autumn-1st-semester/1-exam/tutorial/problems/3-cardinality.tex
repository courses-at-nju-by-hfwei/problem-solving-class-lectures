...
\begin{frame}{}
  \begin{proof}[By Julius K\"{o}nig (1906)]
	...
	\begin{enumerate}[(i)]
	  ...
	  \item \textcolor<4->{red}{$a \in A \leadsto \cdots$}
	    \only<4->{
	      \begin{itemize}
		\item $a \in A \leftrightarrow b \in B$
		\item $a \in A \leadsto a' \in A \leftrightarrow b \in B$
	...
	\uncover<5->{\centerline{\red{Partition} of $A \uplus B$}}
    \end{columns}
  \end{proof}
\end{frame}
%%%%%%%%%%%%%%%
