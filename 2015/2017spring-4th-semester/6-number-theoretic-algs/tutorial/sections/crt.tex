...
\begin{frame}{History of CRT}
  \begin{columns}
	\column{0.50\textwidth}
	  \fignocaption{width = 0.48\textwidth}{figs/ans-crt.png}
	\column{0.50\textwidth}
	  \pause
	  \fignocaption{width = 0.40\textwidth}{figs/sun-crt.png}{\centerline{``物不知数''}}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
\begin{frame}{History of CRT}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Simultaneous incongruences}
  \[
