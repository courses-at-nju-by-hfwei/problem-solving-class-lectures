...
\begin{frame}{}
  ...
  \uncover<3->{
    \centerline{\red{Contradiction: $\exists$ isolated vertices in the other $n - \beta$ vertices.}}
  }
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \pause
  \begin{center}
    \red{Double Counting:} \\[5pt]
    What is the number of \purple{neighbors} of a vertex cover $C$?
  \end{center}
