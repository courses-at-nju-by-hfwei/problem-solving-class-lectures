...
\begin{frame}{}
  ...
  \fignocaption{width = 0.50\textwidth}{figs/taolu-li}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{columns}
	...
	\item \only<1-4>{Define subproblems}\only<5->{\hl{yellow}{Define subproblems}}
	\item Set the goal
	\item \only<1-4>{Identify the recurrence}\only<5->{\hl{yellow}{Identify the recurrence}}
	  \begin{itemize}
  ...
  % \only<5->{
  %     \begin{mdframed}[frametitle = {}, frametitlerule = true, frametitlebackgroundcolor = brown!20,
  %       frametitleaboveskip = 8pt, frametitlebelowskip = 8pt, innertopmargin = 5pt, align = center]
  %       \begin{center}
  %         \purple{\bf Dynamic programming is {\it not} about filling in tables. \\
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.30cm}
  \fignocaption{width = 0.55\textwidth}{figs/no-taolu-mayun}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
  ...
  \pause
  \vspace{-0.30cm}
  \fignocaption{width = 0.60\textwidth}{figs/guess}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \fignocaption{width = 0.70\textwidth}{figs/choices}
    \pause
    \column{0.50\textwidth}
      \begin{enumerate}[(I)]
	\setlength{\itemsep}{8pt}
