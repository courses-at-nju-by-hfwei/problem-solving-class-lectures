...
\begin{frame}{}
  ...
  \pause
  \fignocaption{width = 0.70\textwidth}{figs/HTH-automaton}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \pause
  \vspace{-0.30cm}
  \fignocaption{width = 0.40\textwidth}{figs/HT-pattern}

  \uncover<4->{
    \[
      A = THTTH \qquad \uncover<5->{\E[X_A] = 2(2^1 + 2^4) = 36}
    \]
  }
  \uncover<5->{
    \vspace{-0.30cm}
    \[
      A = HTHTHHTHTH \qquad \uncover<5->{\E[X_A] = 2(2^0 + 2^2 + 2^4 + 2^9) = 1066}
    \]
  }
\end{frame}
%%%%%%%%%%%%%%%
