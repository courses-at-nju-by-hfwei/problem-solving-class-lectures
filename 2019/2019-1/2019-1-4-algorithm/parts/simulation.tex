...
\begin{frame}[fragile]{}
  ...
  \uncover<4->{\fig{width = 0.30\textwidth}{figs/recursion-draw}}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{columns}
    \column{0.45\textwidth}
      \fig{width = 0.80\textwidth}{figs/minimalism}
    \column{0.45\textwidth}
  ...
  \begin{columns}
    ...
    \column{0.30\textwidth}
      \fig{width = 0.50\textwidth}{figs/lambda}
    \column{0.30\textwidth}
      \fig{width = 0.80\textwidth}{figs/mu}
