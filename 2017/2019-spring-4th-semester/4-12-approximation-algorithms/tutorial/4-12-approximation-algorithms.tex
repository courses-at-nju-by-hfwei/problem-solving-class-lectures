...
\newcommand{\pr}{\le_{p}} % polynomial reduction
\newcommand{\nph}{\text{NP-hard}}
\newcommand{\npc}{\text{NP-complete}}
\newcommand{\npi}{\text{NP-intermediate}}
\newcommand{\conpc}{\text{coNP-complete}}
\newcommand{\expcls}{\text{EXP}}
\newcommand{\rcls}{\text{R}}
\newcommand{\dtime}{\text{DTIME}}
\newcommand{\dspace}{\text{SPACE}}
\newcommand{\pspace}{\text{PSPACE}}
\newcommand{\pspacec}{\text{PSPACE-complete}}
\newcommand{\ph}{\text{PH}}
\newcommand{\hp}{\text{HAM-PATH}}
\newcommand{\hc}{\text{HAM-CYCLE}}
\newcommand{\fp}{\text{FP}}
\newcommand{\poly}{\text{Poly}}
\newcommand{\po}{\text{PO}}
\newcommand{\fptas}{\text{FPTAS}}
\newcommand{\ptas}{\text{PTAS}}
\newcommand{\apx}{\text{APX}}
\newcommand{\logapx}{\text{Log-APX}}
\newcommand{\polyapx}{\text{Poly-APX}}
\newcommand{\expapx}{\text{Exp-APX}}
\newcommand{\npo}{\text{NPO}}
\newcommand{\ms}{\text{MS}}

\newcommand{\titletext}{Approximation Algorithms}
...
\titlegraphic{\includegraphics[height = 1.5cm]{figs/qrcode-approx-alg-20170518.png}}
\institute{hfwei@nju.edu.cn}
\date{May 14 $\sim$ May 18, 2017}
...
\input{sections/approx-class}
\input{sections/approx-alg}
\tx{}
