...
%%%%%%%%%%%%%%%
\begin{frame}{}
  \fignocaption{width = 0.40\textwidth}{figs/horse-flower}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{columns}
    ...
    \column{0.50\textwidth}
      \fignocaption{width = 0.55\textwidth}{figs/doit-duck}
    \pause
    \column{0.50\textwidth}
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.50cm}
  \fignocaption{width = 0.25\textwidth}{figs/doit-duck}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.80cm}
  \centerline{\teal{Genearating Functions}}
\end{frame}
%%%%%%%%%%%%%%%
