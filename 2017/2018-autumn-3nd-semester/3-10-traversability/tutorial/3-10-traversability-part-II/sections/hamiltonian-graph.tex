...
\begin{frame}{}
  ...
  \begin{proof}
    \begin{center}
      ...
      \teal{$\exists G$ satisfying Ore's Condition, but $G$ is \red{not} Hamiltonian.} \\[8pt] \pause
      By \red{Extremality}: \\[5pt]
      \teal{Consider a \red{critical} $G$: $G$ is not Hamiltonian but $G + uv$ is Hamiltonian.} \\[8pt] \pause
