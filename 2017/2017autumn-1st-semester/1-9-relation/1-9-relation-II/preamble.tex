...
\usepackage{amsmath, amsfonts, latexsym, mathtools, tabu, wasysym}
\newcommand{\set}[1]{\{#1\}}
...
\newcommand{\csg}{\text{CSG}}
\newcommand{\crm}{\text{CR}}
\newcommand{\cdh}{\text{CDH}}
\newcommand{\snap}{\text{SNAP}}

\newcommand{\course}{\text{Course}}
\newcommand{\cs}{\text{CS}101}
\newcommand{\ee}{\text{EE}200}
\newcommand{\ph}{\text{PH}100}
\newcommand{\sid}{\text{StudentId}}
\newcommand{\grade}{\text{Grade}}
\newcommand{\room}{\text{Room}}
\newcommand{\cday}{\text{Day}}
\newcommand{\hour}{\text{Hour}}
\newcommand{\name}{\text{Name}}

\newcommand{\titletext}{1-9 关系及其基本性质 (II)}
