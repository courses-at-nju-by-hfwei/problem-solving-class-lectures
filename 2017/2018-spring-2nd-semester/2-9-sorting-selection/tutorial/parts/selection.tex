...
\begin{frame}{}
  ...
  % \# \text{Round} = \lceil \log n \rceil
  \uncover<4->{
    \[
      \# \text{\red{Potential} $2$nd smallest elements} \le \lceil \log n \rceil
    \]
  }
...
\begin{frame}{}
  ...
  \pause
  \fignocaption{width = 0.32\textwidth}{figs/knuth-vol3}
  \centerline{\teal{TAOCP Vol 3 (Page 209, Section 5.3.3)}}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.50cm}
  \centerline{\teal{median + subtraction} + \red{$(k+1)$-th smallest + partition} + \teal{add}}
\end{frame}
%%%%%%%%%%%%%%%
