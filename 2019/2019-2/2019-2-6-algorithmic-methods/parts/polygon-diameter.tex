...
\begin{frame}{}
  ...
  \begin{center}
    \input{tikz/convex-polygon-vertex-diameter}
  \end{center}
...
\begin{frame}{}
  \begin{definition}[Antipodal]
    An \red{\it antipodal} is a pair of points that admits \red{\it parallel supporting lines}.
  \end{definition}
...
\begin{frame}{}
  ...
  \begin{center}
    \input{tikz/convex-polygon-antipodal-diameter}
  \end{center}

  \vspace{0.30cm}
  \uncover<2->{
    \begin{center}
      We claim that $l_{A}$ and $l_{B}$ are parallel supporting lines.
    \end{center}
  }

  \uncover<3->{
    \begin{center}
      {$l_{A} \cap P \neq \emptyset$ \qquad $P$ lies entirely on one side of $l_{A}$.}
    \end{center}
  }
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \pause
  \begin{proof}[A Classical and Beautiful Divide-Conquer{\red{-Combine}} Algorithm:]
