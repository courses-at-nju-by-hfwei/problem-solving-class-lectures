...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \fignocaption{width = 0.90\textwidth}{figs/art-gallery}
    \column{0.50\textwidth}
...
\begin{frame}{}
  \begin{exampleblock}{Another Version of the Ear Lemma (Problem $4.1-16$)}
    A triangulated polygon is \teal{either} a triangle with three ears \teal{or} has at least two ears
    (which are \red{\it not necessarily non-adjacent}).
  \end{exampleblock}{}

  \pause
  \vspace{0.30cm}
  \fignocaption{width = 0.40\textwidth}{figs/weak-ear-lemma}

  \pause
  \vspace{0.30cm}
  \centerline{\red{$Q:$ \large \it Adjacent ears?}}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{columns}
    \pause
    \column{0.50\textwidth}
      \fignocaption{width = 0.60\textwidth}{figs/polygon-ear}
    \pause
    \column{0.50\textwidth}
      \fignocaption{width = 0.60\textwidth}{figs/polygon-diagonal}
  \end{columns}

  \pause
  \vspace{0.50cm}
  \centerline{\red{$Q:$ \large \it Existence of diagonals?}}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.80cm}
  \centerline{\red{\large $Q:$ \it Can every polygon be triangulated?}}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \only<1>{\fignocaption{width = 0.90\textwidth}{figs/art-gallery}}
      \only<2->{\fignocaption{width = 0.75\textwidth}{figs/art-gallery-camera}}
    \column{0.50\textwidth}
      \fignocaption{width = 0.70\textwidth}{figs/watching}
  \end{columns}
...
\begin{frame}{}
  ...
  \begin{theorem}[The Art Gallery Theorem \red{($O$)}]
...
%%%%%%%%%%%%%%%
\begin{frame}{}
  \begin{theorem}[The Art Gallery Theorem \red{($\Omega$)}]
...
\begin{frame}{}
  \begin{columns}
    \column{0.50\textwidth}
      \fignocaption{width = 0.60\textwidth}{figs/proofs-from-the-book}
      \centerline{{\it ``How to Guard a Museum?''}}
    \column{0.50\textwidth}
      \pause
      \fignocaption{width = 0.80\textwidth}{figs/polygon-triangulation}
      \[
	O(n \log n) 
      \]
      \[
