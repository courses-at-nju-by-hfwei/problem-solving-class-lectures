...
\begin{frame}{}
  ...
  \begin{columns}
	...
	\item \only<1-2>{Define subproblems}\only<3->{\hl{yellow}{Define subproblems}}
	\item Set the goal
	\item \only<1-2>{Identify the recurrence}\only<3->{\hl{yellow}{Identify the recurrence}}
	  \begin{itemize}
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.30cm}
  \fignocaption{width = 0.55\textwidth}{figs/mayun-no-taolu}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
  ...
  \pause
  \vspace{-0.30cm}
  \fignocaption{width = 0.55\textwidth}{figs/guess}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
