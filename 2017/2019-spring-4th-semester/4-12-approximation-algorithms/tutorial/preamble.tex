...
\usepackage{amsmath, amsfonts, latexsym, mathtools, extarrows, tabu}
...
\newcommand{\ntime}{\text{NTIME}}
\newcommand{\nexp}{\text{NEXP}}
\newcommand{\nexpc}{\text{NEXP-complete}}
\newcommand{\dspace}{\text{SPACE}}
\newcommand{\pspace}{\text{PSPACE}}
\newcommand{\pspacec}{\text{PSPACE-complete}}
\newcommand{\expspacec}{\text{EXPSPACE-complete}}
\newcommand{\partition}{\text{3-PARTITION}}
...
\newcommand{\titletext}{4-12 Approximation Algorithms}
